...
{
  file="xsim.ini"
  lib_map_path="H:/hard_software/vivado2017/install/Vivado/2017.4/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
